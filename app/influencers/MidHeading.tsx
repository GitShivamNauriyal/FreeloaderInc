...
const MidHeading = () => {
    return (
        <div className="px-6 py-12 md:p-16 lg:py-28 bg-white wavy-light-background">
            <h1 className="px-4 md:px-20 lg:px-56 lg:pl-40 max-w-screen-xl mx-auto text-lg sm:text-xl lg:text-4xl text-cente freeheading text-[#5e17eb] font-bold leading-5 lg:leading-8 tracking-wide uppercase">
